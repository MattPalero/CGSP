...
void SceneShooting::Init()
{
	...
	light[0].spotDirection = glm::vec3(0.f, 0.f, 0);
...
void SceneShooting::RenderMeshOnScreen(Mesh* mesh, float x, float y, float sizex, float sizey)
{
...
void SceneShooting::RenderText(Mesh* mesh, std::string text, Color color)
{	
...
void SceneShooting::RenderTextOnScreen(Mesh* mesh, std::string text, Color color, float size, float x, float y)
{
...
void SceneShooting::spawnCollider(glm::vec3 pos, glm::vec3 scale, int number, bool spawn)
{
	modelStack.PushMatrix();
...
void SceneShooting::HandleMouseInut()
{
